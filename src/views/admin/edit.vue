    ...
    <div class="smart-contract-platform">
        <div class="sidebar">
            <aside>
                <nav>
                    <ul>
                        <li :class="{ active: activeMenu === 'home', 'custom-font': true }"
                            @click="setActiveMenu('home')">主页</li>
                        <li :class="{ active: activeMenu === 'new-project', 'custom-font': true }"
                            @click="setActiveMenu('new-project')">新建项目</li>
                        <li :class="{ active: activeMenu === 'view-project', 'custom-font': true }"
                            @click="setActiveMenu('view-project')">查看项目</li>
                        <li :class="{ active: activeMenu === 'new-article', 'custom-font': true }"
                            @click="setActiveMenu('new-article')">新建文章</li>
                        <li :class="{ active: activeMenu === 'view-article', 'custom-font': true }"
                            @click="setActiveMenu('view-article')">查看文章</li>
                        <li :class="{ active: activeMenu === 'drafts', 'custom-font': true }"
                            @click="setActiveMenu('drafts')">草稿箱</li>
                    </ul>
                </nav>
            </aside>
                    ...
                    <tbody>
                        <tr v-for="event in filtered_events" :key="event.id">
                            ...
                            <td>{{ event.enrollNumber }} / {{ event.recruitNumber }}
                                <a @click="viewRegister(event.id)"
                                    style="color: blue; text-decoration: underline; cursor: pointer;">查看</a>
                            </td>
...
.view-button {
    background-color: rgb(14, 132, 201);
    /* 绿色 */
    color: white;
    border: none;
    padding: 10px 20px;
